        ...
        <main className="flex-grow p-4 bg-gray-50">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-6">
              <Card>
                <CardHeader>
                  <CardTitle>Car Park Details</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="space-y-4">
                    <div>
                      <h3 className="text-xl font-bold mb-2">{carPark.name}</h3>
                      <p className="text-gray-500">{carPark.location}</p>
                    </div>
                    ...
                    <div className="border-b pb-4">
                      ...
                      <div className="flex items-center">
                        ...
                        <div>
                          ...
                          <p className="text-gray-500 text-xs">27/01/23</p>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div>
                    <div className="flex items-center mb-2">
                      ...
                      <div>
                        ...
                        <p className="text-gray-500 text-xs">{currentUser.date}</p>
                      </div>
                    </div>
                  </div>
