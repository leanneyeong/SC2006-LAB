    ...
    <>
      ...
      >
        <ToggleGroupItem
          value="Car"
          aria-label="Car"
          className="rounded-none border border-gray-400 px-5 py-2 text-sm data-[state=on]:bg-blue-500 data-[state=on]:text-white"
        >
        ...
        <ToggleGroupItem
          ...
          className="rounded-none border border-l-0 border-gray-400 px-5 py-2 text-sm data-[state=on]:bg-blue-500 data-[state=on]:text-white"
        >
          <div className="text-sm">Motorcycle</div>
        </ToggleGroupItem>

        <ToggleGroupItem
          value="Heavy Vehicle"
          aria-label="Heavy Vehicle"
          className="rounded-none border border-l-0 border-gray-400 px-5 py-2 text-sm data-[state=on]:bg-blue-500 data-[state=on]:text-white"
        >
          Heavy Vehicle
        </ToggleGroupItem>
      ...
      <DisplayParkingRateInfo value={value} />
    </>
  );
}
...
const PeakHourStandardRate = ({
  ...
  return (
    ...
    //   </div>
    //   <div className="text-gray-800">$1.20 / 30 min</div>

    //   <div className="font-medium text-gray-600">
    //     {startOfPeakHour}:00am to {endOfPeakHour}:00pm
    //   </div>
    //   <div className="text-gray-800">$0.80 / 30 min</div>

    //   <div className="font-medium text-gray-600">
    //     {endOfPeakHour}:00pm to 10:30pm
    //   </div>
    //   <div className="text-gray-800">$0.60 / 30 min</div>
...
const DisplayParkingRateInfo = ({ value }: { value: string | null }) => {
